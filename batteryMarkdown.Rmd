...
source("./thebrewery/scripts/gliderGPS_to_dd.R")
...
Last 24hr usage: `r round(ahr1day, 2)` ahr/day

Last 72hr usage: `r round(ahr3day, 2)` ahr/day
...
As of `r posTime$m_present_time` UTC, `r i` is `r round(toGo/1000, 2)` km from the next waypoint.
